<%-- 
    Document   : index
    Created on : Oct 23, 2023, 5:20:45 PM
    Author     : dhair
--%>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-4 fixed-top">
            <div class="container">
                <a
                    ...
                    <span class="fw-lighter ms-2" style="font-size: 28px"
                          ><span style="color: #e5345b; font-size: 32px">S</span>hopiGo</span
                    >
                </a>

                <div class="order-lg-2 nav-btns">
                    <button
                        onclick="window.location.href = 'user.jsp';"
                        type="button"
                    ...
                    <button
                        onclick="window.location.href = 'cart.jsp';"
                        type="button"
                        class="btn position-relative"
                        >
                    ...
                    <div class="collection-list mt-4 row gx-0 gy-3">
                        <div class="col-md-6 col-lg-4 col-xl-3 p-2 best">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-capitalize my-1">Gray Top</p>
                                <span class="fw-bold d-block">$ 40</span>
                                <a href="item1" class="btn btn-primary mt-3">Add to Cart</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 p-2 feat">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-capitalize my-1">
                                    Blue Jeans
                                    <span class="fw-bold d-block">$ 40</span>
                                    <a href="item2" class="btn btn-primary mt-3"
                                       >Add to Cart</a
                                    >
                                </p>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 p-2 new">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-capitalize my-1">Item</p>
                                <span class="fw-bold d-block">$ 40</span>
                                <a href="item3" class="btn btn-primary mt-3">Add to Cart</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 p-2 best">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-capitalize my-1">Item</p>
                                <span class="fw-bold d-block">$ 40</span>
                                <a href="item4" class="btn btn-primary mt-3">Add to Cart</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 p-2 feat">
                            ...
                            <div class="text-center">
                                ...
                                <span class="fw-bold d-block">$ 40</span>
                                <a href="item5" class="btn btn-primary mt-3">Add to Cart</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 p-2 new">
                            ...
                            <div class="text-center">
                                ...
                                <span class="fw-bold d-block">$ 40</span>
                                <a href="item6" class="btn btn-primary mt-3">Add to Cart</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 p-2 best">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-capitalize my-1">Blue Top</p>
                                <span class="fw-bold d-block">$ 40</span>
                                <a href="item7" class="btn btn-primary mt-3">Add to Cart</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 p-2 feat">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-capitalize my-1">Black Top</p>
                                <span class="fw-bold d-block">$ 40</span>
                                <a href="item8" class="btn btn-primary mt-3">Add to Cart</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="special-list row g-0">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 p-2">
                        ...
                        <div class="text-center">
                            <p class="text-capitalize mt-3 mb-1">Kurti</p>
                            <span class="fw-bold d-block">$ 40</span>
                        ...
                        <div class="card-body px-0">
                            ...
                            <p class="card-text">
                                <small class="text-muted">
                                    <span class="fw-bold">Author: </span>Dhairya
                                </small>
                            </p>
                    ...
                    <div class="col-md-6 col-lg-4 row g-3">
                        ...
                        <div class="d-flex align-items-start justify-content-start">
                            <img
                                ...
                                />
                            <div>
                                <p class="mb-0">Black-White Shirt</p>
                                <span>$ 49.99</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-start justify-content-start">
            ...
            <div class="container">
                <div class="row text-white g-4">
                    <div class="col-md-6 col-lg-3">
                        <a class="text-decoration-none brand text-white" href="index.html"
                           >ShopiGo</a
                        >
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="my-3">
                                <a
                                    ...
                                    class="text-white text-decoration-none text-muted"
                                    >
                                    <i class="fas fa-chevron-right me-1"></i> Special
                                </a>
                            </li>
                            <li class="my-3">
                                <a
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div
                            ...
                            <span class="fw-light">
                                Ground Floor, Eros Plaza, Eros Corporate Centre, Nehru Place,
                                New Delhi-110019 Delhi South Delhi DL IN 110019.
                            </span>
                        </div>
                        <div
                            class="d-flex justify-content-start align-items-start my-2 text-muted"
                            ...
                            <span class="fw-light"> shopigo.support@gmail.com </span>
                        </div>
                        <div
                            class="d-flex justify-content-start align-items-start my-2 text-muted"
                            >
                            ...
                            <span class="fw-light"> +91 866776236 </span>
                        </div>
                    </div>
